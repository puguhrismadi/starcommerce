        ...
        <div class="uk-grid-medium uk-child-width-1-1 uk-grid uk-grid-stack" uk-grid="">
            ...
            <div class="uk-grid-margin uk-first-column">
                            ...
                            <div class="uk-grid-small uk-grid-collapse uk-grid-match uk-grid" uk-grid="">
                                <div class="uk-width-1-1 uk-width-expand@m uk-first-column">
                                    <div class="uk-grid-collapse uk-child-width-1-1 uk-slideshow uk-grid uk-grid-stack"
                                        ...
                                        <div class="uk-first-column">
                                            <ul class="uk-slideshow-items" uk-lightbox="" style="height: 600px;">
                                                <li class="uk-active uk-transition-active"
                                                    style="transform: translateX(0px);"><a
                                                            ...
                                                            <div class="uk-slider-container">
                                                                <ul class="tm-slider-items uk-slider-items uk-child-width-1-4 uk-grid uk-grid-small"
                                                                    ...
                                                                    <li uk-slideshow-item="0"
                                                                        class="uk-transition-active uk-active">
                                                                ...
                                                                <div><a class="uk-position-center-left-out uk-position-small uk-slidenav-previous uk-icon uk-slidenav uk-invisible"
                                                                        ...
                                                                        class="uk-position-center-right-out uk-position-small uk-slidenav-next uk-icon uk-slidenav"
                                                                        href="#" uk-slider-item="next"
                                                                        uk-slidenav-next=""><svg width="14" height="24"
                                                                            viewBox="0 0 14 24"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <polyline fill="none" stroke="#000"
                                                                                stroke-width="1.4"
                                ...
                                <div class="uk-width-1-1 uk-width-1-3@m tm-product-info">
                                    <div class="uk-card-body">
                                        <div><a href="#" title="Apple"><img src="images/brands/apple.svg" alt="Apple"
                                            ...
                                            <div class="uk-grid-small uk-grid" uk-grid="">
                                                <div class="uk-flex uk-flex-middle uk-first-column">
                                                    <ul class="uk-iconnav uk-margin-xsmall-bottom tm-rating">
                                                        <li><span class="uk-text-warning uk-icon" uk-icon="star"><svg
                                                ...
                                                <div><span class="uk-label uk-label-warning uk-margin-xsmall-right">top
                                                        selling</span><span
                                        ...
                                        <div class="uk-margin">
                                            <div class="uk-grid-medium uk-grid" uk-grid="">
                                                <div class="uk-first-column">
                                                    ...
                                                    <ul class="uk-subnav uk-subnav-pill tm-variations" uk-switcher="">
                                                        <li aria-expanded="true" class="uk-active"><a
                                                                class="tm-variation-color" uk-tooltip="Space Grey"
                                                                title="" aria-expanded="false">
                                                                <div style="background-color: #aaaeb1"></div>
                                                            </a></li>
                                                        <li aria-expanded="false"><a class="tm-variation-color"
                                                                uk-tooltip="Silver" title="" aria-expanded="false">
                                                ...
                                                <div>
                                                    ...
                                                    <ul class="uk-subnav uk-subnav-pill tm-variations" uk-switcher="">
                                                        <li aria-expanded="true" class="uk-active"><a>256 GB</a></li>
                                                        <li aria-expanded="false"><a>512 GB</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="uk-grid-small uk-grid" uk-grid="">
                                                            ...
                                                            <div
                                                                ...
                                                                <a class="uk-margin-small-right js-add-to js-add-to-favorites tm-action-button-active js-added-to"
                                                                    uk-tooltip="Add to favorites" title=""
                                                                    aria-expanded="false"><span uk-icon="heart"
                                                                        class="uk-icon"><svg width="20" height="20"
                                                                            viewBox="0 0 20 20"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    uk-tooltip="Add to compare" title=""
                                                                    aria-expanded="false"><span uk-icon="copy"
                                                                        class="uk-icon"><svg width="20" height="20"
                                                                            viewBox="0 0 20 20"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <rect fill="none" stroke="#000" x="3.5"
                                                                                y="2.5" width="12" height="16"></rect>
                                                                            <polyline fill="none" stroke="#000"
                                        ...
                                        <div class="uk-margin">
                                            <div class="uk-padding-small uk-background-muted uk-border-rounded">
                                                <div class="uk-grid-small uk-child-width-1-1 uk-text-small uk-grid uk-grid-stack"
                                                    uk-grid="">
                                                    <div class="uk-first-column">
                                                        <div class="uk-grid-collapse uk-grid" uk-grid=""><span
                                                                class="uk-margin-xsmall-right uk-icon uk-first-column"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="uk-text-xsmall uk-text-muted">In stock,
                                                                    free, tomorrow</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="uk-grid-margin uk-first-column">
                                                        <div class="uk-grid-collapse uk-grid" uk-grid=""><span
                                                                class="uk-margin-xsmall-right uk-icon uk-first-column"
                                                                uk-icon="location"><svg width="20" height="20"
                                                                    viewBox="0 0 20 20"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    <circle fill="none" stroke="#000" cx="10" cy="6.8"
                                                                        r="2.3"></circle>
                                                                </svg></span>
                                                            <div>
                                        ...
                                        <div class="uk-margin">
                                            ...
                                            <div class="uk-margin-small-top"><a
                                                    class="uk-link-heading js-scroll-to-description" href="#description"
                                                    onclick="UIkit.switcher('.js-product-switcher').show(1);"><span
                                                        class="tm-pseudo">Detailed specifications</span><span
                                                        class="uk-margin-xsmall-left uk-icon"
                                                        uk-icon="icon: chevron-down; ratio: .75;"><svg width="15"
                                                            height="15" viewBox="0 0 20 20"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <polyline fill="none" stroke="#000" stroke-width="1.03"
                                                                points="16 7 10 13 4 7"></polyline>
                                                        </svg></span></a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="uk-width-1-1 tm-product-description uk-grid-margin uk-first-column"
                                    ...
                                    <div class="uk-card-body">
                                        <div class="uk-switcher js-product-switcher js-tabs">
                                                ...
                                                <article class="uk-article">
                                                    <div class="uk-article-body">
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            Pellentesque euismod nisl nunc, a dictum magna laoreet eget.
                                                        ...
                                                        <p>Sed sit amet ante eget nunc dictum auctor sagittis in libero.
                                                            Aliquam ultricies tincidunt nisi, a vestibulum nisi tempor
                                                            vitae. Praesent fermentum sem semper fermentum ultrices.
                                                            Duis eleifend vel sapien dignissim auctor. Vestibulum at
                                                            commodo leo. In vitae eros ut sapien egestas venenatis non
                                                            sit amet elit. In gravida vitae ante a rutrum.</p>
                                                        <h2>Touch Bar</h2>
                                                        <p>Vivamus ornare tortor elit, sed rutrum felis iaculis in. Nunc
                                                            ut molestie neque. Aenean vitae elementum arcu, at rutrum
                                                            ligula. Pellentesque fringilla dictum viverra. Vestibulum eu
                                                            ipsum nec risus pharetra iaculis. Donec quis nulla orci.
                                                            Suspendisse eget dictum augue, et lobortis justo.
                                                            Suspendisse velit dui, sollicitudin quis velit nec,
                                                            tincidunt consequat arcu.</p>
                                                        <h2>Retina Display</h2>
                                                        <p>Pellentesque dictum imperdiet rutrum. Vestibulum egestas quam
                                                            eget maximus rutrum. Etiam blandit a dolor laoreet
                                                            vulputate. Nulla ullamcorper ipsum et libero finibus, vitae
                                                        ...
                                                        <p>Ut arcu lacus, tempus bibendum purus sed, iaculis
                                                            sollicitudin sapien. Donec quis imperdiet arcu. Ut sagittis
                                                            ipsum diam, nec tempor ex fermentum a. Nam ac vehicula erat.
                                                            Curabitur id congue risus, vel iaculis enim. Donec tristique
                                                            lacinia velit eu fringilla. Mauris lectus enim, aliquet eu
                                                            dolor sed, porta vehicula lacus. Etiam luctus egestas
                                                            scelerisque. Sed sit amet metus ante. Cras pulvinar
                                                            sollicitudin nisl nec egestas. Maecenas vitae velit ut urna
                                                            vestibulum venenatis ut vel ex. Quisque sit amet mattis
                                                            ante. Duis blandit nisl non commodo rutrum. Nulla in velit
                                                            ut arcu efficitur laoreet ut eu mauris. Duis condimentum
                                                            vulputate consequat. Vestibulum aliquet suscipit purus.</p>
                                                        <figure uk-slideshow="" class="uk-slideshow">
                                                            <div
                                                                class="uk-position-relative uk-visible-toggle uk-light">
                                                                <ul class="uk-slideshow-items" style="height: 360px;">
                                                                    <li class="uk-active uk-transition-active"
                                                                        style="transform: translateX(0px);"><img
                                                                            src="images/articles/macbook-promo-1.jpg"
                                                                            alt="MacBook Pro" uk-cover=""
                                                                            class="uk-cover"
                                                                            style="height: 380px; width: 640px;"></li>
                                                                    ...
                                                                    uk-slideshow-item="previous"><svg width="14"
                                                                        height="24" viewBox="0 0 14 24"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <polyline fill="none" stroke="#000"
                                                                            stroke-width="1.4"
                                                                    ...
                                                                    uk-slideshow-item="next"><svg width="14" height="24"
                                                                        viewBox="0 0 14 24"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <polyline fill="none" stroke="#000"
                                                                            stroke-width="1.4"
                                                            ...
                                                            <ul
                                                                ...
                                                                <li uk-slideshow-item="0" class="uk-active"><a
                                                                        href="#"></a></li>
                                                                <li uk-slideshow-item="1"><a href="#"></a></li>
                                                            </ul>
                                                        </figure>
                                                        <p>Mauris dignissim non nulla quis sollicitudin. Maecenas quis
                                                            orci dui. Suspendisse pharetra facilisis metus, at venenatis
                                                            nisl convallis et. Curabitur vulputate eget nisl sed
                                                            dignissim. Sed eget metus ut orci volutpat gravida.</p>
                                                        <div class="twitter-tweet twitter-tweet-rendered"
                                                            ...
                                                            <iframe id="twitter-widget-0" scrolling="no"
                                                                ...
                                                                style="position: static; visibility: visible; width: 550px; height: 509px; display: block; flex-grow: 1;"
                                                                title="Twitter Tweet"
                                                                src="https://platform.twitter.com/embed/index.html?dnt=false&amp;embedId=twitter-widget-0&amp;frame=false&amp;hideCard=false&amp;hideThread=false&amp;id=948539601265872896&amp;lang=en&amp;origin=https%3A%2F%2Fchekromul.github.io%2Fuikit-ecommerce-template%2Fproduct.html&amp;theme=light&amp;widgetsVersion=219d021%3A1598982042171&amp;width=550px"
                                                                data-tweet-id="948539601265872896"
                                                                frameborder="0"></iframe></div>
                                                        <script src="https://platform.twitter.com/widgets.js"
                                                            charset="utf-8" async=""></script>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            Quisque sem urna, accumsan nec velit et, convallis tincidunt
                                                            enim. Proin sollicitudin, metus at interdum tempus, velit mi
                                                            posuere nisl, nec viverra ligula lorem sit amet felis. Class
                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th></th>
                                                                    <th class="uk-width-1-4 uk-text-center">MacBook Pro
                                                                        13"</th>
                                                                    <th class="uk-width-1-4 uk-text-center">MacBook Pro
                                                                        13" with Touch Bar</th>
                                                                    <th class="uk-width-1-4 uk-text-center">MacBook Pro
                                                                        15" with Touch Bar</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                        ...
                                                        <p>Sed at diam aliquet, fringilla turpis ac, consequat ante.
                                                            Duis id maximus purus. Cras rutrum erat non nibh accumsan,
                                                            vitae maximus sapien elementum. Maecenas tellus libero,
                                                            vulputate vitae mi eu, volutpat ornare felis. Nulla
                                                            malesuada nunc urna, quis rutrum massa consequat id.
                                                            Pellentesque elit diam, dignissim a lorem eu, tincidunt
                                                            mollis erat.</p>
                                                        <div class="tm-wrapper">
                                                            <figure class="uk-text-center"><a
                                                        ...
                                                        <p>Sed at diam aliquet, fringilla turpis ac, consequat ante.
                                                            ...
                                                            mollis erat.</p>
                                                        <blockquote cite="#">
                                                            <p class="uk-margin-small-bottom">You can converge a toaster
                                                                and refrigerator, but these things are probably not
                                                                going to be pleasing to the user.</p>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="uk-table-expand">AMD Radeon&nbsp;Pro 555 with
                                                                2&nbsp;GB&nbsp;GDDR5 VRAM,<br>Intel HD Graphics&nbsp;630
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="uk-table-expand">1 × 256&nbsp;GB&nbsp;Integrated
                                                                PCIe</td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="uk-table-expand">4 × Thunderbolt 3&nbsp;via USB
                                                                Type-C</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="uk-width-medium">Display</th>
                                                            <td class="uk-table-expand">4 × DisplayPort&nbsp;via Type-C
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="uk-width-medium">Audio</th>
                                                            <td class="uk-table-expand">1 × 1/8" (3.5&nbsp;mm) Headphone
                                                                Output,<br>2 × Integrated Speaker,<br>3 × Integrated
                                                                Microphone</td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="uk-table-expand">Not Specified by Manufacturer
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="uk-table-expand">76&nbsp;Wh&nbsp;Non-Removable
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="uk-table-expand">100-240&nbsp;VAC, 50-60&nbsp;Hz
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="uk-table-expand">Keys: 64,<br>Type: Standard
                                                                Notebook Keyboard,<br>Features: Backlight</td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <section>
                                                <div class="tm-wrapper">
                                                    <div class="uk-grid-collapse uk-child-width-1-3@s uk-child-width-1-4@m tm-products-grid uk-grid uk-grid-stack"
                                                        uk-grid="">
                                                            ...
                                                            <div class="tm-product-card-body">
                                                                <div class="tm-product-card-info">
                                                                    ...
                                                                    <h3 class="tm-product-card-title"><a
                                                                            ...
                                                                            href="product.html">Apple MacBook Pro 15"
                                                                            Touch Bar MPTU2LL/A 256GB (Silver)</a></h3>
                                                                    <ul
                                                                        class="uk-list uk-text-small tm-product-card-properties">
                                                                        <li><span class="uk-text-muted">Diagonal
                                                                                display: </span><span>15.4"</span></li>
                                                                        ...
                                                                        <li><span class="uk-text-muted">Video Card:
                                                                            </span><span>AMD Radeon Pro 555</span></li>
                                                                    </ul>
                                                                </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a class="tm-product-card-action js-add-to js-add-to-favorites tm-action-button-active js-added-to"
                                                                                ...
                                                                                title="Add to compare"><span
                                                                                    ...
                                                                                    class="tm-product-card-action-text">Add
                                                                                    to compare</span></a></div><button
                                                                            class="uk-button uk-button-primary tm-product-card-add-button tm-shine js-add-to-cart"><span
                                                                                class="tm-product-card-add-button-icon uk-icon"
                                                                                uk-icon="cart"><svg width="20"
                                                        ...
                                                        <article class="tm-product-card">
                                                            ...
                                                            <div class="tm-product-card-body">
                                                                <div class="tm-product-card-info">
                                                                    ...
                                                                    <h3 class="tm-product-card-title"><a
                                                                            class="uk-link-heading"
                                                                            href="product.html">Apple MacBook 12"
                                                                            MNYN2LL/A 512GB (Rose Gold)</a></h3>
                                                                    <ul
                                                                        class="uk-list uk-text-small tm-product-card-properties">
                                                                        <li><span class="uk-text-muted">Diagonal
                                                                                display: </span><span>12"</span></li>
                                                                        <li><span class="uk-text-muted">CPU:
                                                                        ...
                                                                        <li><span class="uk-text-muted">Video Card:
                                                                            </span><span>Intel® HD Graphics 615</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="tm-product-card-shop">
                                                            ...
                                                            <div class="tm-product-card-body">
                                                                <div class="tm-product-card-info">
                                                                    ...
                                                                    <ul
                                                                        class="uk-list uk-text-small tm-product-card-properties">
                                                                        <li><span class="uk-text-muted">Diagonal
                                                                                display: </span><span>13.9"</span></li>
                                                                        <li><span class="uk-text-muted">CPU:
                                                            ...
                                                            <div class="tm-product-card-body">
                                                                <div class="tm-product-card-info">
                                                                    ...
                                                                    <ul
                                                                        class="uk-list uk-text-small tm-product-card-properties">
                                                                        <li><span class="uk-text-muted">Diagonal
                                                                                display: </span><span>13.3"</span></li>
                                                                        <li><span class="uk-text-muted">CPU:
                                                                        ...
                                                                        <li><span class="uk-text-muted">Video Card:
                                                                            </span><span>Intel® HD Graphics 520</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="tm-product-card-shop">
                                                        ...
                                                        <article class="tm-product-card">
                                                            ...
                                                            <div class="tm-product-card-body">
                                                                <div class="tm-product-card-info">
                                                                    ...
                                                                    <h3 class="tm-product-card-title"><a
                                                                            class="uk-link-heading"
                                                                            href="product.html">Dell XPS 15 9560-8968
                                                                            (Silver)</a></h3>
                                                                    <ul
                                                                        class="uk-list uk-text-small tm-product-card-properties">
                                                                        <li><span class="uk-text-muted">Diagonal
                                                                                display: </span><span>15.6"</span></li>
                                                                        <li><span class="uk-text-muted">CPU:
                                                                            </span><span>Intel®&nbsp;Core™ i7
                                                                                7700HQ</span></li>
                                                                        <li><span class="uk-text-muted">RAM:
                                                                        ...
                                                                        <li><span class="uk-text-muted">Video Card:
                                                                            </span><span>NVIDIA GeForce GTX 960M</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="tm-product-card-shop">
                                                        ...
                                                        <article class="tm-product-card">
                                                            ...
                                                            <div class="tm-product-card-body">
                                                                <div class="tm-product-card-info">
                                                                    ...
                                                                    <h3 class="tm-product-card-title"><a
                                                                            class="uk-link-heading"
                                                                            href="product.html">Apple MacBook Air 13"
                                                                            MQD32LL/A 128GB (Silver)</a></h3>
                                                                    <ul
                                                                        class="uk-list uk-text-small tm-product-card-properties">
                                                                        <li><span class="uk-text-muted">Diagonal
                                                                                display: </span><span>13.3"</span></li>
                                                                        ...
                                                                        <li><span class="uk-text-muted">Video Card:
                                                                            </span><span>Intel® HD Graphics 6000</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="tm-product-card-shop">
                                                        ...
                                                        <article class="tm-product-card">
                                                            ...
                                                            <div class="tm-product-card-body">
                                                                <div class="tm-product-card-info">
                                                                    ...
                                                                    <h3 class="tm-product-card-title"><a
                                                                            class="uk-link-heading"
                                                                            href="product.html">Dell Inspiron 5378-2063
                                                                            (Gray)</a></h3>
                                                                    <ul
                                                                        class="uk-list uk-text-small tm-product-card-properties">
                                                                        <li><span class="uk-text-muted">Diagonal
                                                                        ...
                                                                        <li><span class="uk-text-muted">HDD Capacity:
                                                        ...
                                                        <article class="tm-product-card">
                                                            ...
                                                            <div class="tm-product-card-body">
                                                                <div class="tm-product-card-info">
                                                                    ...
                                                                    <h3 class="tm-product-card-title"><a
                                                                            class="uk-link-heading"
                                                                            href="product.html">Lenovo Yoga 720-13IKB
                                                                            80X60059RK (Silver)</a></h3>
                                                                    <ul
                                                                        class="uk-list uk-text-small tm-product-card-properties">
                                                                        <li><span class="uk-text-muted">Diagonal
                                                                                display: </span><span>13.3"</span></li>
                                                            ...
                                                            <div class="tm-product-card-media">
                                                                <div class="tm-ratio tm-ratio-4-3"><a
                                                                        ...
                                                                        <figure class="tm-media-box-wrap"><span
                                                                                class="uk-text-muted uk-icon"
                                                                                uk-icon="icon: image; ratio: 3;"><svg
                                                                                    width="60" height="60"
                                                                                    viewBox="0 0 20 20"
                                                                                    xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div class="tm-product-card-body">
                                                                <div class="tm-product-card-info">
                                                                    ...
                                                                    <ul
                                                                        ...
                                                                        <li><span class="uk-text-muted">Video Card:
                                                                            </span><span>Intel® UHD Graphics 620</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="tm-product-card-shop">
                                                                    <div class="tm-product-card-prices">
                                                                        <div class="uk-text-muted">Product not available
                                                                        </div>
                                                                    </div>
                                                                    <div class="tm-product-card-add">
                                                                        <div
                                            ...
                                            <section>
                                                <div class="uk-grid-small uk-grid-divider uk-grid uk-grid-stack"
                                                    uk-grid="">
                                                    <div
                                                        ...
                                                        <div class="uk-flex uk-flex-center">
                                                            <ul class="uk-iconnav tm-rating">
                                                                <li><span class="uk-text-warning uk-icon"
                                                                        uk-icon="star"><svg width="20" height="20"
                                                                            viewBox="0 0 20 20"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <polygon fill="none" stroke="#000"
                                                                                stroke-width="1.01"
                                                        ...
                                                        <div class="uk-margin-small-top uk-text-meta">based on 2 reviews
                                                        </div><button
                                                        ...
                                                        <div class="uk-grid-small uk-grid-divider uk-child-width-1-1 uk-grid uk-grid-stack"
                                                            ...
                                                            <article>
                                                                <section
                                                                    ...
                                                                    uk-grid="">
                                                                    <header>
                                                                        <div class="uk-h4 uk-margin-remove">Thomas Bruns
                                                                        </div><time class="uk-text-meta">May 21,
                                                                            2018</time>
                                                                    </header>
                                                                    <div>
                                                                        <ul
                                                                        ...
                                                                        <div class="uk-grid-small uk-flex-middle uk-margin-top uk-grid uk-grid-stack"
                                                                            uk-grid="">
                                                                            <div class="uk-text-meta">Was this review
                                                                                helpful to you?</div>
                                                                            <div><button
                                                            ...
                                                            <article>
                                                                <section
                                                                    ...
                                                                    uk-grid="">
                                                                    <header>
                                                                        <div class="uk-h4 uk-margin-remove">George
                                                                            Clanton</div><time class="uk-text-meta">May
                                                                            24, 2018</time>
                                                                    </header>
                                                                    <div>
                                                                        <ul
                                                                        ...
                                                                        <div>
                                                                            <p>Nunc interdum odio non erat commodo
                                                                                lacinia. Aliquam nec tincidunt lorem.
                                                                                Nunc quis scelerisque nulla. Nam nulla
                                                                                ante, luctus non dignissim a, luctus
                                                                                quis sem. Curabitur consectetur
                                                                                porttitor leo. Donec molestie nisl vitae
                                                                                lorem porttitor vehicula. Etiam feugiat
                                                                                a magna ac dapibus. Donec vitae
                                                                                sollicitudin lectus.</p>
                                                                            <p>Sed mollis ex tincidunt posuere blandit.
                                                                                Mauris sed tellus dolor. Suspendisse
                                                                                nibh mi, dignissim et molestie id,
                                                                                dictum in arcu. Duis sodales scelerisque
                                                                                quam, quis lobortis felis egestas eu.
                                                                                Sed nibh nulla, aliquet ac leo vel,
                                                                                rutrum dignissim metus. Sed non rhoncus
                                                                                ex. Curabitur accumsan porta lacus non
                                                                                viverra. Etiam feugiat sapien ut purus
                                                                                luctus, eu porttitor neque volutpat.</p>
                                                                        </div>
                                                                        <div class="uk-grid-small uk-flex-middle uk-margin-top uk-grid uk-grid-stack"
                                                                            uk-grid="">
                                                                            <div class="uk-text-meta">Was this review
                                            ...
                                            <section>
                                                <ul class="uk-list-divider uk-list-large uk-accordion"
                                                    uk-accordion="multiple: true">
                                                    <li><a class="uk-accordion-title" href="#">Lorem ipsum dolor sit
                                                        ...
                                                        <div class="uk-accordion-content" aria-hidden="true" hidden="">
                                                            ...
                                                            imperdiet, condimentum eros vel, ullamcorper turpis.
                                                            Maecenas sed libero quis orci egestas vehicula fermentum id
                                                            diam.</div>
                                                    </li>
                                                    <li><a class="uk-accordion-title" href="#">Nullam massa sem, mollis
                                                            ut luctus at, tincidunt a lorem?</a>
                                                        <div class="uk-accordion-content" aria-hidden="true" hidden="">
                                                            Aliquam sed dictum elit, quis consequat metus. Proin in
                                                    ...
                                                    <li><a class="uk-accordion-title" href="#">Aliquam pretium diam et
                                                        ...
                                                        <div class="uk-accordion-content" aria-hidden="true" hidden="">
                                                            Praesent feugiat lectus faucibus tellus congue pharetra. In
                                                            viverra vehicula pellentesque. Etiam consectetur ultricies
                                                            magna at bibendum.</div>
                                                    </li>
                                                    <li><a class="uk-accordion-title" href="#">Nulla fringilla
                                                            sollicitudin mauris eu volutpat?</a>
                                                        <div class="uk-accordion-content" aria-hidden="true" hidden="">
                                                            Mauris quis neque nec lectus aliquet malesuada. Nunc
                                                            ullamcorper purus id gravida aliquam. Integer eget blandit
                                                            urna.</div>
                                                    </li>
                                                    <li><a class="uk-accordion-title" href="#">Nam luctus velit ante, id
                                                            pulvinar nisl gravida eget?</a>
                                                        <div class="uk-accordion-content" aria-hidden="true" hidden="">
                                                            Vestibulum gravida nisi tempor malesuada iaculis. Phasellus
                                                            finibus, nisl quis pellentesque scelerisque, erat erat
                                                            mollis massa, eu semper diam eros id risus. Cras vitae nisi
                                                            porta.</div>
                                                    </li>
                                                </ul>
                                            </section>
                    ...
                    <section class="uk-grid-margin uk-first-column">
                        <div uk-slider="finite: true" class="uk-slider">
                            <div class="uk-grid-small uk-flex-middle uk-margin-bottom uk-grid" uk-grid="">
                                <h2 class="uk-width-expand uk-text-center uk-text-left@s uk-first-column">Related
                                    Products</h2>
                                <div class="uk-visible@s"><a
                                        class="tm-slidenav uk-slidenav-previous uk-icon uk-slidenav uk-invisible"
                                        href="#" uk-slider-item="previous" uk-slidenav-previous=""><svg width="14"
                                            height="24" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg">
                                            <polyline fill="none" stroke="#000" stroke-width="1.4"
                                                points="12.775,1 1.225,12 12.775,23 "></polyline>
                                        </svg></a><a class="tm-slidenav uk-slidenav-next uk-icon uk-slidenav" href="#"
                                        uk-slider-item="next" uk-slidenav-next=""><svg width="14" height="24"
                                                ...
                                                <article class="tm-product-card uk-active">
                                                    ...
                                                    <div class="tm-product-card-body">
                                                        <div class="tm-product-card-info">
                                                            ...
                                                            <h3 class="tm-product-card-title"><a class="uk-link-heading"
                                                                    href="product.html">Apple MacBook 12" MNYN2LL/A
                                                                    512GB (Rose Gold)</a></h3>
                                                            <ul
                                                                class="uk-list uk-text-small tm-product-card-properties">
                                                                <li><span class="uk-text-muted">Diagonal display:
                                                                    </span><span>12"</span></li>
                                                                <li><span class="uk-text-muted">CPU:
                                                                    </span><span>Intel®&nbsp;Core™ i5</span></li>
                                                                <li><span class="uk-text-muted">RAM:
                                                                    </span><span>8&nbsp;GB</span></li>
                                                                <li><span class="uk-text-muted">Video Card:
                                                                    </span><span>Intel® HD Graphics 615</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="tm-product-card-shop">
                                                            <div class="tm-product-card-prices">
                                                ...
                                                <article class="tm-product-card uk-active">
                                                    ...
                                                    <div class="tm-product-card-body">
                                                        <div class="tm-product-card-info">
                                                            ...
                                                            <h3 class="tm-product-card-title"><a class="uk-link-heading"
                                                                    href="product.html">Lenovo IdeaPad YOGA 920-13IKB
                                                            ...
                                                            <ul
                                                                ...
                                                                <li><span class="uk-text-muted">CPU:
                                                                    </span><span>Intel®&nbsp;Core™ i7 8550U</span></li>
                                                                <li><span class="uk-text-muted">RAM:
                                                                    </span><span>16&nbsp;GB</span></li>
                                                                <li><span class="uk-text-muted">Video Card:
                                                                    </span><span>Intel® HD Graphics 620</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="tm-product-card-shop">
                                                            <div class="tm-product-card-prices">
                                                ...
                                                <article class="tm-product-card uk-active">
                                                    ...
                                                    <div class="tm-product-card-body">
                                                        <div class="tm-product-card-info">
                                                            ...
                                                            <h3 class="tm-product-card-title"><a class="uk-link-heading"
                                                                    href="product.html">ASUS Zenbook UX330UA-FC020T
                                                                    (Rose Gold)</a></h3>
                                                            <ul
                                                                class="uk-list uk-text-small tm-product-card-properties">
                                                                <li><span class="uk-text-muted">Diagonal display:
                                                                ...
                                                                <li><span class="uk-text-muted">CPU:
                                                                    </span><span>Intel®&nbsp;Core™ i7-6500U</span></li>
                                                                <li><span class="uk-text-muted">RAM:
                                                                    </span><span>8&nbsp;GB</span></li>
                                                                <li><span class="uk-text-muted">Video Card:
                                                                    </span><span>Intel® HD Graphics 520</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="tm-product-card-shop">
                                                            <div class="tm-product-card-prices">
                                                    ...
                                                    <div class="tm-product-card-body">
                                                        <div class="tm-product-card-info">
                                                            ...
                                                            <ul
                                                                ...
                                                                <li><span class="uk-text-muted">CPU:
                                                                    </span><span>Intel®&nbsp;Core™ i7 7700HQ</span></li>
                                                                <li><span class="uk-text-muted">RAM:
                                                                    </span><span>16&nbsp;GB</span></li>
                                                                <li><span class="uk-text-muted">Video Card:
                                                                    </span><span>NVIDIA GeForce GTX 960M</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="tm-product-card-shop">
                                                            <div class="tm-product-card-prices"><del
                                                ...
                                                <article class="tm-product-card">
                                                    ...
                                                    <div class="tm-product-card-body">
                                                        <div class="tm-product-card-info">
                                                            ...
                                                            <h3 class="tm-product-card-title"><a class="uk-link-heading"
                                                                    href="product.html">Apple MacBook Air 13" MQD32LL/A
                                                                    128GB (Silver)</a></h3>
                                                            <ul
                                                                class="uk-list uk-text-small tm-product-card-properties">
                                                                <li><span class="uk-text-muted">Diagonal display:
                                                                ...
                                                                <li><span class="uk-text-muted">Video Card:
                                                                    </span><span>Intel® HD Graphics 6000</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="tm-product-card-shop">
                                                            <div class="tm-product-card-prices">
                                                    ...
                                                    <div class="tm-product-card-body">
                                                        <div class="tm-product-card-info">
                                                            ...
                                                            <ul
                                                                ...
                                                                <li><span class="uk-text-muted">CPU:
                                                                    </span><span>Intel®&nbsp;Core™ i3-7100U</span></li>
                                                                <li><span class="uk-text-muted">RAM:
                                                                    </span><span>4&nbsp;GB</span></li>
                                                                <li><span class="uk-text-muted">HDD Capacity:
                                                                    </span><span>1&nbsp;TB</span></li>
                                                ...
                                                <article class="tm-product-card">
                                                    ...
                                                    <div class="tm-product-card-body">
                                                        <div class="tm-product-card-info">
                                                            ...
                                                            <h3 class="tm-product-card-title"><a class="uk-link-heading"
                                                                    href="product.html">Lenovo Yoga 720-13IKB 80X60059RK
                                                                    (Silver)</a></h3>
                                                            <ul
                                                                class="uk-list uk-text-small tm-product-card-properties">
                                                                <li><span class="uk-text-muted">Diagonal display:
                                                                ...
                                                                <li><span class="uk-text-muted">CPU:
                                                                    </span><span>Intel®&nbsp;Core™ i5-7200U</span></li>
                                                                <li><span class="uk-text-muted">RAM:
                                                                    </span><span>8&nbsp;GB</span></li>
                                                                <li><span class="uk-text-muted">Video Card:
                                                                    </span><span>Intel® HD Graphics 620</span></li>
                                                ...
                                                <article class="tm-product-card">
                                                    <div class="tm-product-card-media">
                                                        <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box"
                                                                ...
                                                                <figure class="tm-media-box-wrap"><span
                                                                        class="uk-text-muted uk-icon"
                                                                        uk-icon="icon: image; ratio: 3;"><svg width="60"
                                                                            height="60" viewBox="0 0 20 20"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <circle cx="16.1" cy="6.1" r="1.1"></circle>
                                                                            <rect fill="none" stroke="#000" x="0.5"
                                                                                y="2.5" width="19" height="15"></rect>
                                                                            <polyline fill="none" stroke="#000"
                                                                                stroke-width="1.01"
                                                    ...
                                                    <div class="tm-product-card-body">
                                                        <div class="tm-product-card-info">
                                                            ...
                                                            <h3 class="tm-product-card-title"><a class="uk-link-heading"
                                                                    href="product.html">Lenovo ThinkPad X380 Yoga
                                                                    20LH000MUS (Black)</a></h3>
                                                            <ul
                                                                class="uk-list uk-text-small tm-product-card-properties">
                                                                <li><span class="uk-text-muted">Diagonal display:
                                                                    </span><span>13.3"</span></li>
                                                                ...
                                                                <li><span class="uk-text-muted">Video Card:
                                                                    </span><span>Intel® UHD Graphics 620</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="tm-product-card-shop">
                                                            <div class="tm-product-card-prices">
                ...
                <div id="review" uk-modal="" class="uk-modal">
                    <div class="uk-modal-dialog uk-modal-body"><button class="uk-modal-close-outside uk-close uk-icon"
                            type="button" uk-close=""><svg width="14" height="14" viewBox="0 0 14 14"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <form class="uk-form-stacked">
                            <div class="uk-grid-small uk-child-width-1-1 uk-grid uk-grid-stack" uk-grid="">
                                ...
                                <div>
                                    ...
                                    <ul class="uk-iconnav tm-rating">
                                        <li><a uk-icon="star" class="uk-icon"><svg width="20" height="20"
                                ...
                                <div><label>
                                        <div class="uk-form-label uk-form-label-required">Review</div><textarea
                                            class="uk-textarea" rows="5" required=""></textarea>
                                    </label></div>
                                <div class="uk-text-center"><button class="uk-button uk-button-primary">Send</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="uk-container">
        <div uk-slider="" class="uk-slider uk-slider-container">
            <ul class="uk-slider-items uk-child-width-1-1 uk-child-width-1-2@s uk-child-width-1-5@m uk-grid"
                ...
                <li class="uk-active">
                    <div class="uk-grid-small uk-flex-center uk-flex-left@s uk-grid" uk-grid="">
                        <div class="uk-first-column"><span uk-icon="icon: receiver; ratio: 2.5;" class="uk-icon"><svg
                                    width="50" height="50" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="none" stroke="#000" stroke-width="1.01"
                ...
                <li class="uk-active">
                    <div class="uk-grid-small uk-flex-center uk-flex-left@s uk-grid" uk-grid="">
                        <div class="uk-first-column"><span uk-icon="icon: location; ratio: 2.5;" class="uk-icon"><svg
                                    width="50" height="50" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="none" stroke="#000" stroke-width="1.01"
                                        d="M10,0.5 C6.41,0.5 3.5,3.39 3.5,6.98 C3.5,11.83 10,19 10,19 C10,19 16.5,11.83 16.5,6.98 C16.5,3.39 13.59,0.5 10,0.5 L10,0.5 Z">
                                    </path>
                ...
                <li class="uk-active">
                    <div class="uk-grid-small uk-flex-center uk-flex-left@s uk-grid" uk-grid="">
                        <div class="uk-first-column"><span uk-icon="icon: comments; ratio: 2.5;" class="uk-icon"><svg
                                    width="50" height="50" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="uk-active">
                    <div class="uk-grid-small uk-flex-center uk-flex-left@s uk-grid" uk-grid="">
                        <div class="uk-first-column"><span uk-icon="icon: happy; ratio: 2.5;" class="uk-icon"><svg
                                    ...
                                    <path fill="none" stroke="#000"
                                        d="M14.6,11.4 C13.9,13.3 12.1,14.5 10,14.5 C7.9,14.5 6.1,13.3 5.4,11.4"></path>
                                </svg></span></div>
                        <div class="uk-text-center uk-text-left@s uk-width-expand@s">
