                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title">
                                                                    <a class="uk-link-heading" href="produk">Apple
                                                            ...
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title">
                                                                    <a class="uk-link-heading"
                                                                        href="produk">Lenovo IdeaPad YOGA
                                                                        920-13IKB
                                                                        80Y7001RRK (Copper)</a>
                                                                </h3>
                                                                <ul
                                                    ...
                                                    <article class="tm-product-card">
                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title">
                                                                    <a class="uk-link-heading" href="produk">ASUS
                                                                        Zenbook UX330UA-FC020T (Rose
                                                                        Gold)</a>
                                                                </h3>
                                                                <ul
                                                                    class="uk-list uk-text-small tm-product-card-properties">
                                                                    ...
                                                                    <li>
                                                                        <span class="uk-text-muted">CPU:
                                                                        </span><span>Intel®&nbsp;Core™ i7-6500U</span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="uk-text-muted">RAM:
                                                                        </span><span>8&nbsp;GB</span>
                                                    ...
                                                    <article class="tm-product-card">
                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title">
                                                                    <a class="uk-link-heading" href="produk">Dell
                                                                        XPS 15 9560-8968 (Silver)</a>
                                                                </h3>
                                                                <ul
                                                                    class="uk-list uk-text-small tm-product-card-properties">
                                                                    <li>
                                                                    ...
                                                                    <li>
                                                                        <span class="uk-text-muted">CPU:
                                                                        </span><span>Intel®&nbsp;Core™ i7 7700HQ</span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="uk-text-muted">RAM:
                                                                        </span><span>16&nbsp;GB</span>
                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <ul
                                                                    ...
                                                                    <li>
                                                                        <span class="uk-text-muted">CPU:
                                                                        </span><span>Intel®&nbsp;Core™ i3-7100U</span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="uk-text-muted">RAM:
                                                                        </span><span>4&nbsp;GB</span>
                                                                    ...
                                                                    <li>
                                                                        <span class="uk-text-muted">HDD Capacity:
                                                                        </span><span>1&nbsp;TB</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                    ...
                                                    <article class="tm-product-card">
                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title">
                                                                    <a class="uk-link-heading"
                                                                        href="produk">Lenovo Yoga 720-13IKB
                                                                        80X60059RK
                                                                        (Silver)</a>
                                                                </h3>
                                                                <ul
                                                                    ...
                                                                    <li>
                                                                        <span class="uk-text-muted">CPU:
                                                                        </span><span>Intel®&nbsp;Core™ i5-7200U</span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="uk-text-muted">RAM:
                                                                        </span><span>8&nbsp;GB</span>
                                                    ...
                                                    <article class="tm-product-card">
                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title">
                                                                    <a class="uk-link-heading"
                                                                        href="produk">Lenovo ThinkPad X380 Yoga
                                                                        20LH000MUS
                                                                        (Black)</a>
                                                                </h3>
                                                                <ul
